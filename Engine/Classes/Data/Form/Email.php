...
class Email extends Text
{
    ...
    {
        $this->html = \INS\Template::i()->getTemplate( 'core', 'forms', 'email', $this )->renderOptions();
    ...
    public function validate()
    {
        ...
        if( !\INS\Data\Validation::i()->email( $this->value ) )
        {
            $this->errors = \INS\Language::i()->strings['form_email_invalid'];
            $this->valid = FALSE;
        }
