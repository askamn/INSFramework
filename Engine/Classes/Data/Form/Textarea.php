...
class Textarea extends FormAbstract
{
	...
	protected $defaultOptions = [
        ...
        'cols'                 => NULL,  // The width of the textarea
        'rows'                 => NULL,  // The height of the textarea
        'readonly'             => FALSE, // Readonly attribute
        'wrap'                 => NULL,  // Wrap attribute (hard/soft)
    ...
    {
        $this->html = \INS\Template::i()->getTemplate( 'core', 'forms', 'textarea', $this )->renderOptions();

        $this->html = str_replace( 
            [ '{%name%}', '{%value%}', '{%attributes%}', '{%id%}', '{%validationjs%}', '{%required%}' ], 
            [ $this->name, $this->value, $this->attributes, $this->id, $this->validationJS(), ( $this->required == TRUE ? 'required="required"' : '' ) ], 
            $this->html 
        );
