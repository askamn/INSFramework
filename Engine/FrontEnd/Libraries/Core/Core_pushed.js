...
jQuery(document).ready(
	function(){
		...
		var insModernSearch = jQuery( '#ins-fullscreensearch' ), input = jQuery( '.ins-input' ), ctrlClose = jQuery( '.ins-fullscreensearch-close' ),
...
jQuery(document).ready( function(){ jQuery('.ins-reset').click(function(e){ jQuery('#ins_id_register').trigger('reset'); e.preventDefault(); }); });